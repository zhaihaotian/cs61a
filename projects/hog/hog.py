...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        return False
    g = gcd(player_score, opponent_score)
    if g >= 10 :
        return True
    else:
        return False
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def commentary(current_score , opponent_score):
        nonlocal last_score , running_high
        score = current_score if who == 0 else opponent_score
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    ans = 0
    for _ in range(1,11):
        now_score = make_averaged(roll_dice , trials_count)(_ , dice)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    temp_score = free_bacon(opponent_score) + score
    # print('temp_score:', temp_score)
    # print("free_bacon:", free_bacon(opponent_score))
    if extra_turn(temp_score , opponent_score) :
        return 0
    else :
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if extra_turn(temp_score , opponent_score) or temp_score >= 100:
        return 0
    dice = six_sided
    best_score , best_choice = 0 , 0
    for _ in range(1,11):
        now_score = make_averaged(roll_dice, 10)(_ , dice)
        if now_score + score >= 100:
            return _
